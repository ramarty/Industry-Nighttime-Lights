...
ggsave(p, filename = file.path(figures_file_path, paste0("gwr_diff6_coef_hist_neg.png")), 
       height=7, width=8) 
...
stargazer(lm1,
          ...
          #report="vcs*",
          digits = 2,
          out=file.path(tables_file_path, paste0("predict_gwr_coef_changes_neg.tex")))
...
ggsave(p, filename = file.path(figures_file_path, paste0("gwr_diff6_neg.png")), 
       height=7, width=8) 
