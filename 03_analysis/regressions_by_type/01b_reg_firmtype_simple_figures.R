...
# Make Figures -----------------------------------------------------------------
## Canada - Firms
can_firm <- make_figure(df, "canada", "N_firms_sum")
ggsave(can_firm, filename = file.path(figures_file_path, "reg_firmtype_simpleols_can_firm.png"), height = 8, width=15)

## Canada - Employment
can_employ <- make_figure(df, "canada", "employment_sum")
ggsave(can_employ, filename = file.path(figures_file_path, "reg_firmtype_simpleols_can_employ.png"), height = 8, width=15)

## Mexico - Firms
mex_firm <- make_figure(df, "mexico", "N_firms_sum")
ggsave(mex_firm, filename = file.path(figures_file_path, "reg_firmtype_simpleols_mex_firm.png"), height = 8, width=15)
